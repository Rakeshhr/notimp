...
<head>
    ...
    <!-- Title -->
    <title>Hemanth B V - Photography HTML Template</title>
                    ...
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12 col-lg-8 col-xl-6">
                            <div class="welcome-text">
                                <h2 data-animation="bounceInDown" data-delay="900ms">Hello <br>I'm Hemanth</h2>
                                ...
                                <div class="hero-btn-group" data-animation="bounceInDown" data-delay="100ms">
                                    ...
                                    <a class="hero-mail-contact" href="mailto:hello.alime@gmail.com">hemanthbv17@gmail.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(img/bg-img/2.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12 col-lg-8 col-xl-6">
                            <div class="welcome-text">
                                <h2 data-animation="bounceInUp" data-delay="100ms">Hello <br>I'm Rakesh</h2>
